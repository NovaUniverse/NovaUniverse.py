...
def player(player_name:str=None, player_uuid:str=None): #Find a player and return data as player object.
    ...
    return player(plain_data["id"], plain_data["uuid"], plain_data["username"], plain_data["first_join_timestamp"]["date"], plain_data["last_join_timestamp"]["date"], plain_data["is_online"], plain_data["sessions"])
...
def session(session_id:str): #Find a game session and return data as a full session object.
    ...
    return session(plain_data["game"], plain_data["session_id"], plain_data["metadata"], plain_data["total_places"], plain_data["timestamp"], plain_data["players"])
